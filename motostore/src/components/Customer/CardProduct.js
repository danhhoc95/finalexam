                ...
                <div className="card-body">
                    ...
                    <div className="d-flex mt-2 justify-content-between">
                        <a href={`/product-detail/` + this.props.productID}>
                            <button type="button" className="btn-cart-product btn btn-outline-primary">
                                <i className="fas fa-eye"/>Xem chi tiết
                            </button>
                        </a>
                        <button onClick={() => { addCart(this.props.productID) }} type="button" className="btn-cart-product btn btn-primary">
