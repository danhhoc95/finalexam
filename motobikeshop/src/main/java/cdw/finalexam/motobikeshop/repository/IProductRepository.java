...
public interface IProductRepository extends JpaRepository<Product, Integer>{
    ...
    @Query(value = "SELECT * FROM Product WHERE  price >= :minPrice and " +
            " price <= :maxPrice and height >= :minHeight and  " +
            "  height <= :maxHeight and (:origin is null or origin = :origin)", nativeQuery = true)
